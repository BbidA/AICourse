...
public class ForwardModel extends Game
{
    ...
    */
    ...
    public boolean equals(Object o) {
        ...
        return this.equalObservations(that);
    }

    @Override
    public int hashCode() {

        int result = Objects.hash(observations);
        result = 31 * result + Arrays.hashCode(movList);
        result = 31 * result + Arrays.hashCode(visibleList);
        return result;
    }
}
